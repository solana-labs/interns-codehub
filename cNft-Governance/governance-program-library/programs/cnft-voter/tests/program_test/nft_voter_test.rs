...
impl NftVoterTest {
    ...
    pub async fn relinquish_nft_vote(
        ...
        let data =
            anchor_lang::InstructionData::data(&gpl_cnft_voter::instruction::RelinquishNftVote {});
        ...
        let accounts = gpl_cnft_voter::accounts::RelinquishNftVote {
            registrar: registrar_cookie.address,
            voter_weight_record: voter_weight_record_cookie.address,
    ...
    pub async fn cast_nft_vote(
        ...
        let data = anchor_lang::InstructionData::data(&gpl_cnft_voter::instruction::CastNftVote {
            proposal: proposal_cookie.address,
        });

        let accounts = gpl_cnft_voter::accounts::CastNftVote {
            registrar: registrar_cookie.address,
            voter_weight_record: voter_weight_record_cookie.address,
            voter_token_owner_record: voter_token_owner_record_cookie.address,
