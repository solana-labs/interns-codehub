...
use crate::program_test::nft_voter_test::NftVoterTest;
use crate::program_test::token_metadata_test::CreateNftArgs;
use crate::program_test::tools::*;
...
#[tokio::test]
async fn test_update_nft_voter_weight_record() -> Result<(), TransportError> {
    // Arrange
    ...
    let _collection_config_cookie = nft_voter_test.with_collection(
        &registrar_cookie,
    ...
    let nft1_cookie = nft_voter_test.token_metadata.with_nft_v2(
        &nft_collection_cookie,
        &voter_cookie,
        None
    ).await?;
    ...
    // Act
    nft_voter_test.update_nft_voter_weight_record(
        &registrar_cookie,
...
async fn test_update_voter_weight_with_cast_vote_not_allowed_error() -> Result<(), TransportError> {
    ...
    let err = nft_voter_test
        .update_nft_voter_weight_record(
            &registrar_cookie,
            &mut voter_weight_record_cookie,
...
#[tokio::test]
async fn test_update_nft_voter_weight_record_with_no_nft_error() -> Result<(), TransportError> {
    // Arrange
    let mut nft_voter_test = NftVoterTest::start_new().await;
