...
use crate::program_test::{ nft_voter_test::*, tools::{ assert_gov_err, assert_nft_voter_err } };
...
#[tokio::test]
async fn test_cast_nft_vote_using_multiple_instructions_with_nft_already_voted_error() -> Result<
    (),
    TransportError
> {
    // Arrange
...
#[tokio::test]
async fn test_cast_nft_vote_using_multiple_instructions_with_attempted_sandwiched_relinquish() -> Result<
    (),
    TransportError
> {
    // Arrange
...
#[tokio::test]
async fn test_cast_nft_vote_with_invalid_voter_weight_token_owner_error() -> Result<
    (),
    TransportError
> {
    // Arrange
