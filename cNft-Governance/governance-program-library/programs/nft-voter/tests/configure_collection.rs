...
async fn test_configure_collection() -> Result<(), TransportError> {
    ...
    let nft_collection_cookie = nft_voter_test.token_metadata.with_nft_collection(None).await?;
    ...
    // Act
    let collection_config_cookie = nft_voter_test.with_collection(
        &registrar_cookie,
    ...
    // Assert
    let registrar = nft_voter_test.get_registrar_account(&registrar_cookie.address).await;
    ...
    let max_voter_weight_record = nft_voter_test.get_max_voter_weight_record(
    ...
    assert_eq!(
        ...
        ((registrar.collection_configs[0].weight as u32) *
            registrar.collection_configs[0].size) as u64
    );
...
async fn test_configure_multiple_collections() -> Result<(), TransportError> {
    ...
    let nft_collection_cookie1 = nft_voter_test.token_metadata.with_nft_collection(None).await?;
    let nft_collection_cookie2 = nft_voter_test.token_metadata.with_nft_collection(None).await?;
...
async fn test_configure_max_collections() -> Result<(), TransportError> {
    ...
    assert_eq!(registrar.collection_configs.len() as u8, registrar_cookie.max_collections);
...
async fn test_configure_collection_with_invalid_realm_error() -> Result<(), TransportError> {
    ...
    let err = nft_voter_test
        .with_collection_using_ix(
            ...
            None,
            |i| {
                i.accounts[1].pubkey = realm_cookie2.address;
            }, // realm
            None
        ).await
        .err()
...
#[tokio::test]
async fn test_configure_collection_with_realm_authority_must_sign_error() -> Result<
    (),
    TransportError
> {
    // Arrange
...
#[tokio::test]
async fn test_configure_collection_with_invalid_realm_authority_error() -> Result<
    (),
    TransportError
> {
    // Arrange
    ...
    let err = nft_voter_test
        .with_collection_using_ix(
            ...
            None,
            |i| {
                i.accounts[2].pubkey = realm_authority.pubkey();
            }, // realm_authority
...
#[tokio::test]
async fn test_configure_collection_with_invalid_max_voter_weight_realm_error() -> Result<
    (),
    TransportError
> {
    // Arrange
...
#[tokio::test]
async fn test_configure_collection_with_invalid_max_voter_weight_mint_error() -> Result<
    (),
    TransportError
> {
    // Arrange
